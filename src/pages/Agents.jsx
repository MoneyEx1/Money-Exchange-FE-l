...
const currencyData = [
  { country: "Ko ko", flag: "0912345678", symbol: "Dawei" },
  { country: "Aung Aung", flag: "0912345678", symbol: "Baangok" },
...
const Agents = () => {
  ...
  const columns = [
    { key: "country", title: "Customer Name" },
    { key: "flag", title: "Phone Number" },
    { key: "symbol", title: "Address" },
    {
      key: "actions",
      title: "Actions",
    ...
    <>
      <div className="min-h-screen flex flex-col justify-start items-center lg:ml-64 bg-gradient-to-br from-sky-200 via-indigo-100 to-purple-200">
        <div className="px-3 flex flex-col gap-3 md:flex-row items-start md:justify-between w-full  mb-8 mt-8">
          ...
          <button
            className="bg-blue-500 md:mt-16 max-w-[300px] text-white px-10  py-4 rounded-2xl text-2xl font-serif shadow-lg flex items-center justify-center gap-2"
